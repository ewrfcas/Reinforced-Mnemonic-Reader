...
class Model(object):
    ...
    def build_model(self):
        ...
        with tf.variable_scope("Answer_Pointer"):
            ...
            logits2 = end_logits(R, logits1, s, mask=self.c_mask, filters=self.filters, name='End_Pointer')  # [bs, c_len]
        ...
        with tf.variable_scope("Loss_Layer"):
            ...
            if self.use_rlloss:
                with tf.variable_scope("Reinforcement_Loss"):
                    self.rl_loss, _, _ = rl_loss(logits1, logits2, self.y_start, self.y_end, self.c_maxlen)
        ...
        with tf.variable_scope('Output_Layer'):
            ...
            self.mask_output1 = tf.argmax(tf.reduce_max(outer_masked, axis=2), axis=1)
